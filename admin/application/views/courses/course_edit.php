    ...
    <!-- Breadcrumbs -->
        ...
        <form method="POST" action="<?=base_url()?>index.php/general/courses" enctype="multipart/form-data" >
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <input class="form-control" required type="text" value="<?= $courses['course_name'] ?>" placeholder="" name="course_name">
              </div>
            </div>
			<div class="form-group row">
              <label for="example-text-input" class="col-2 col-form-label">Course Description</label>
              <div class="col-10">
                <textarea name="course_desc" id="course_desc" rows="10" cols="80"><?= $courses['course_desc'] ?></textarea>
              </div>
            </div>
			<div class="form-group row">
              <label for="example-text-input" class="col-2 col-form-label">Course Years</label>
              <div class="col-10">
                <input class="form-control" required type="text" value="<?= $courses['course_years'] ?>" placeholder="" name="course_years">
              </div>
            </div>
			<div class="form-group row">
              <label for="example-text-input" class="col-2 col-form-label">Course Seasons</label>
              <div class="col-10">
                <input class="form-control" required type="text" value="<?= $courses['course_seasons'] ?>" placeholder="" name="course_seasons">
              </div>
            </div>
			<div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <div style="display:flex">
					Enable<input class="form-control" style="width:10%" type="radio" placeholder="" name="course_status" value="1" <?= ($courses['course_status'] == "1")?"checked":"" ?> />
					Disable<input class="form-control" style="width:10%" type="radio" placeholder="" name="course_status" value="0" <?= ($courses['course_status'] == "0")?"checked":"" ?> />
				</div>
              </div>
            </div>
            <div class="form-group row"> 
