...
?>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Upcoming Event</li>
            </ol>
		...
		?>
            ...
            <input type="hidden" name="e_id" value="<?= $upcoming_events['e_id'] ?>">
			<div class="form-group row">
              <label for="example-text-input" class="col-2 col-form-label">Upcoming Event Name</label>
              <div class="col-10">
                <input class="form-control" required type="text" value="<?= $upcoming_events['e_name'] ?>" placeholder="" name="e_name">
              </div>
            </div>
			<div class="form-group row">
              <label for="example-text-input" class="col-2 col-form-label">Upcoming Event Description</label>
              <div class="col-10">
                <textarea name="e_desc" class="form-control" required ><?= $upcoming_events['e_desc'] ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <p><img height="120" width="200" src="<?= str_replace("admin","",base_url())?>assets/custom/upcoming_events/<?= $upcoming_events['e_image_url'] ?>"><br/><br/><input name="image_name" id="image_name" readonly="readonly" type="file" /></p>
              </div>
            </div>
            <div class="form-group row"> 
              <div class="col-10">
