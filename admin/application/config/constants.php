...
if (empty($project_parent_folder) == false) {
	...
	define('PROJECT_COOKIE_PATH', '/'.$project_parent_folder.'/admin/');
} else {
	define('APP_ROOT_DIR', ''); //main folder which wraps complete application
	define('PROJECT_COOKIE_PATH', '/admin/');
}


define('MODULE_ROOT_DIR', '/admin'); //main folder which holds current module
define('PROJECT_URI', APP_ROOT_DIR.MODULE_ROOT_DIR);
define('PROJECT_COOKIE_NAME', 'admin');
